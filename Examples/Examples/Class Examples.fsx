...
//let (a,b,c) = (17, "abc", true);;

let cadd a = (fun b -> a+b);;  // non-curried function let print a b =      printfn "a=%i y=%i" a b  print 5 10  // curried function let print a =      let printHelper b =         printfn "a=%i y=%i" a b     printHelper  print 5 10